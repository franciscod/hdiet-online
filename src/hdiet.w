...
@d Book Directory @{/server1/pub/www.fourmilab.ch/web/hackdiet@}
@d Production Book Directory @{/server/pub/www.fourmilab.ch/web/hackdiet@}
...
@d Web Directory @{@<Book Directory@>/online@}
@d Production Web Directory @{@<Production Book Directory@>/online@}
...
@d CGI Installation Directory @{/server1/bin/httpd/cgi-bin@}
@d Production CGI Installation Directory @{/server/bin/httpd/cgi-bin@}
...
@d Cluster Member Hosts @{server0.fourmilab.ch server1.fourmilab.ch server2.fourmilab.ch@}
...
dist:
        ...
        ( cd Bowdler ; make pdf )
        ( cd Bowdler ; tar cfvz hdiet-@<Version@>.tar.gz hdiet.w jig.pl Bowdler.pl \
...
@d Source installation
@{
pubsrc:
        if [ ! -d $(WEBDIR)/download/@<Version@> ] ; then mkdir $(WEBDIR)/download/@<Version@> ; fi
        cp -p Bowdler/hdiet-@<Version@>.tar.gz $(WEBDIR)/download/@<Version@>
        cp -p Bowdler/hdiet.pdf $(WEBDIR)/download/@<Version@>

prodsrc:
        if [ ! -d $(WEBDIR_PRODUCTION)/download/@<Version@> ] ; then mkdir $(WEBDIR_PRODUCTION)/download/@<Version@> ; fi
        cp -p Bowdler/hdiet-@<Version@>.tar.gz $(WEBDIR_PRODUCTION)/download/@<Version@>
        cp -p Bowdler/hdiet.pdf $(WEBDIR_PRODUCTION)/download/@<Version@>
@}
}
